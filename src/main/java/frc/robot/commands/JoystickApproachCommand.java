...
public class JoystickApproachCommand extends Command {
    ...
    public JoystickApproachCommand withTolerance(double driveTolerance, Rotation2d thetaTolerance)
    {
    ...
    public JoystickApproachCommand finishWithinTolerance(boolean finish)
    {
    ...
    public void execute()
    {
        ...
        Translation2d offsetVector =
            new Translation2d(0.0, yController.calculate(relativePose2d.getY()));

        // Calculate total linear velocity
        Translation2d linearVelocity = offsetVector
            .plus(DriveCommands.getLinearVelocityFromJoysticks(joystickSupplier.getAsDouble(), 0.0))
