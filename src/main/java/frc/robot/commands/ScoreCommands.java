...
public class ScoreCommands {
    ...
    private class ScoreCoralCommandFactory {
        ...
        private ScoreCoralCommandFactory(Drive drive, Supplier<Pose2d> robot,
        ...
        private Command get()
        {
            ...
            Command updateTarget = Commands.run(() -> {
                ...
                approachTarget =
                    new Pose2d(approachTarget.getTranslation().plus(offsetTranslation),
                        targetRotation);
            ...
            Command approach = Commands.parallel(
                ...
                driveApproach
                    .until(() -> updateTarget.isFinished() && driveApproach.withinTolerance()),
                Commands.sequence(
    ...
    public static Command scoreCoral(Drive drive,
        Superstructure superstruct, ClawRoller roller, ClawRollerLaserCAN clawLaserCAN,
        FrontLeftLaserCAN frontLeftLaserCAN, FrontRightLaserCAN frontRightLaserCAN,
        Supplier<ReefHeight> height, ReefSide side)
    {
    ...
    public static Command scoreCoral(Drive drive, Supplier<Pose2d> robot,
        Superstructure superstruct, ClawRoller roller, ClawRollerLaserCAN clawLaserCAN,
        FrontLeftLaserCAN frontLeftLaserCAN, FrontRightLaserCAN frontRightLaserCAN,
        Supplier<ReefHeight> height, ReefSide side)
    {
