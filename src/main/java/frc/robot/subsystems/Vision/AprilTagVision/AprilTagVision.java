...
public class AprilTagVision {
    ...
    public void periodic()
    {
        ...
        for (int cameraIndex = 0; cameraIndex < io.length; cameraIndex++) {
            ...
            // Log camera datadata
            Logger.recordOutput(
                "Vision/AprilTag/Camera" + Integer.toString(cameraIndex) + "/TagPoses",
                tagPoses.toArray(new Pose3d[tagPoses.size()]));
            Logger.recordOutput(
                "Vision/AprilTag/Camera" + Integer.toString(cameraIndex) + "/RobotPoses",
                robotPoses.toArray(new Pose3d[robotPoses.size()]));
            Logger.recordOutput(
                "Vision/AprilTag/Camera" + Integer.toString(cameraIndex) + "/RobotPosesAccepted",
                robotPosesAccepted.toArray(new Pose3d[robotPosesAccepted.size()]));
            Logger.recordOutput(
                "Vision/AprilTag/Camera" + Integer.toString(cameraIndex) + "/RobotPosesRejected",
        ...
        // Log summary data
        Logger.recordOutput(
            "Vision/AprilTag/Summary/TagPoses",
